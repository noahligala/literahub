...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        SubscriptionPlan::query()->upsert([
            ['name' => 'Student Monthly', 'slug' => 'student-monthly', 'audience' => 'student', 'billing_period' => 'monthly', 'price_minor' => 50000, 'currency' => 'KES', 'user_limit' => 1, 'features' => json_encode(['core_library', 'reader', 'notes', 'quizzes']), 'is_active' => true],
            ['name' => 'Student Annual', 'slug' => 'student-annual', 'audience' => 'student', 'billing_period' => 'annual', 'price_minor' => 500000, 'currency' => 'KES', 'user_limit' => 1, 'features' => json_encode(['full_library', 'reader', 'notes', 'quizzes']), 'is_active' => true],
